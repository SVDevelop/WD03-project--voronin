			...
			<div class="col-md-10">
				<div class="blog-full-post">
					...
					<div class="blog__info-wrap">
						<span class="blog__name"><?=$post['name']?>	<?=$post['secondname']?></span>
						<span class="blog__travel">
							<a href="<?=HOST?>blog?id=<?=$post['cat']?>"><?=$post['cat_title']?></a>
						</span>
					...
					<div class="blog__image">
						...
						<?php } else { ?>
						<img src="<?=HOST?>usercontent/no_img/920.jpg" alt="<?=$post['title']?>" />
						<?php } ?>
					</div>
