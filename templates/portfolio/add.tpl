			...
			<form class="form mb-100 pb-20 pt-35">
				<div class="fieldset">
					<label>
						...
						<input class="input" placeholder="Введите название работы" />
					</label>
				</div>
				<div class="fieldset">
					...
					<div class="control-row">
						<div class="file">
							<label class="file__label">
								<input class="file__input" type="file" name="file1" />
				...
				<div class="fieldset">
					<label>
						...
						<textarea class="textarea height-200" rows="7" placeholder="Введите описание"></textarea>
					</label>
				</div>
				<div class="fieldset">
					<label>
				...
				<div class="row fieldset mb-30">
					<div class="col-4">
						<label>
							...
							<input class="input" placeholder="Введите ссылку" />
						</label>
					</div>
					<div class="col-4">
						<label>
				...
				<div class="row">
					<div class="col-md-auto pr-10">
						<a class="button button--save" href="#"> Сохранить</a>
					</div>
